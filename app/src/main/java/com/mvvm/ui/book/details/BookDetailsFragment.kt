package com.mvvm.ui.book.details
...
import com.mvvm.R
import com.mvvm.ui.book.BookSearchViewModel
...
class BookDetailsFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel!!.init()
        viewModel!!.getVolumeDetails("","")
        viewModel!!.getVolumeDetailsResponseLiveData()?.observe(this
        ) {
